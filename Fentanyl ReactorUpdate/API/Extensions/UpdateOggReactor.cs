...
{
    public class UpdateOggReactor
    {
        private static readonly string RepositoryUrl = "https://api.github.com/repos/FentanylReactorGER/FentanylAudio/releases/latest";
        private static readonly string AudioFileName = "FentReactorTest.ogg";
