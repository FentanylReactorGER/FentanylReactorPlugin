...
{
    public class UpdateOggDemonCore
    {
        private static readonly string RepositoryUrl = "https://api.github.com/repos/FentanylReactorGER/FentReactorDemonCoreOgg/releases/latest";
        private static readonly string AudioFileName = "DemonCore.ogg";
