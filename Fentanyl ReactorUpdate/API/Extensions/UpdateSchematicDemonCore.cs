...
{
    public class UpdateSchematicDemonCoreChecker
    {
        private static readonly string RepositoryUrl = "https://api.github.com/repos/FentanylReactorGER/DemonCoreSchematic/releases/latest";
        private static readonly string SchematicsPath = Path.Combine(Paths.Configs, "MapEditorReborn", "Schematics");
        private static readonly string FentanylReactorPath = Path.Combine(SchematicsPath, "demon_core");
        ...
        public UpdateSchematicDemonCoreChecker()
        {
